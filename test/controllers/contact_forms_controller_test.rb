...
class ContactFormsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_form" do
    assert_difference('ContactForm.count') do
      post contact_forms_url, params: { contact_form: { email: @contact_form.email, first_name: @contact_form.first_name, last_name: @contact_form.last_name, message: @contact_form.message, phone_number: @contact_form.phone_number } }
    end
  ...
  test "should update contact_form" do
    patch contact_form_url(@contact_form), params: { contact_form: { email: @contact_form.email, first_name: @contact_form.first_name, last_name: @contact_form.last_name, message: @contact_form.message, phone_number: @contact_form.phone_number } }
